...
class Property(db.Model):
    ...
    property_id = db.Column(db.String(180), primary_key=True)

    host_id = db.Column(db.String(180), db.ForeignKey('users.user_id'), nullable=False)
    ...
    property_picture = db.Column(db.String(200), default='prop_default.jpg', nullable=False)
...
class PropertyImage(db.Model):
    ...
    image_id = db.Column(db.String(180), primary_key=True)
    property_id = db.Column(db.String(180), db.ForeignKey('properties.property_id'), nullable=False)
    image_url = db.Column(db.String(300), nullable=False)
    upload_timestamp = db.Column(db.DateTime, default=datetime.utcnow)
    description = db.Column(db.String(100))  # Optional


class Excursion(db.Model):
    """Excursion model for activities offered at a property."""
    __tablename__ = 'excursions'
    excursion_id = db.Column(db.String(180), primary_key=True)
    property_id = db.Column(db.String(180), db.ForeignKey('properties.property_id'), nullable=False)
    title = db.Column(db.String(150), nullable=False)
    description = db.Column(db.Text, nullable=True)
...
class Booking(db.Model):
    ...
    booking_id = db.Column(db.String(180), primary_key=True)

    customer_id = db.Column(db.String(180), db.ForeignKey('users.user_id'), nullable=False)
    property_id = db.Column(db.String(180), db.ForeignKey('properties.property_id'), nullable=False)
...
class BookingExcursion(db.Model):
    ...
    booking_id = db.Column(db.String(180), db.ForeignKey('bookings.booking_id'), nullable=False)
    excursion_id = db.Column(db.String(180), db.ForeignKey('excursions.excursion_id'), nullable=False)
...
class Payment(db.Model):
    ...
    payment_id = db.Column(db.String(180), primary_key=True)
    booking_id = db.Column(db.String(180), db.ForeignKey('bookings.booking_id'), nullable=False)
...
class Ride(db.Model):
    ...
    __tablename__ = 'rides'
    ride_id = db.Column(db.String(180), primary_key=True)
    booking_id = db.Column(db.String(180), db.ForeignKey('bookings.booking_id'), nullable=False)
...
class Flight(db.Model):
    ...
    flight_id = db.Column(db.String(180), primary_key=True)
